...
import static cn.seu.cs.eshop.account.redis.AccountRedisConfEnum.accountEmailVerify;
...
public class EmailVerifyCache {
    ...
    public EmailVerifyDO getEmailVerifyDO(String account) {
        ...
        if (entity == null) {
            ...
            Long verifyTime = eshopConfService.getConfigObject(AccountNacosConfEnum.emailVerifyTime, Long.class);
